...
//					);
				jQuery(document).bind(
					...
					function(e)
					{
						var pointer = jQuery.iUtil.getPointer(e);//获取鼠标位置
						var toAdd = 0;
...
//解决ie下报错的问题。
			x += el.offsetLeft + (el.currentStyle && !$.support.opera ?parseInt(el.currentStyle.borderLeftWidth)||0:0);
			y += el.offsetTop + (el.currentStyle && !$.support.opera ?parseInt(el.currentStyle.borderTopWidth)||0:0);
