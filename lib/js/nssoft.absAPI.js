...
(function() {
    $class('nssoft.absAPI').extend($d.api.ajaxAPI).define({
        ...
        onBlockUIPopup:function(){
            ...
            this.blockUI.style.width = document.body.scrollWidth + 'px';
            this.blockUI.style.zIndex = '10000';
            this.blockUI.style.filter = 'alpha(opacity=65);';
            this.blockUI.style.MozOpacity = 0.65;
            this.blockUI.style.opacity = 0.65;
            this.blockUI.style.KhtmlOpacity = 0.65;
...
//            this.popupUI.style.border = '3px solid rgb(0,0,0)';
            ...
            var errorMsg = '<img src="../lib/img/bg/loading.gif" />';
